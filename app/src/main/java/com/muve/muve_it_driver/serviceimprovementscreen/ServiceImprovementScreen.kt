package com.muve.muve_it_driver.serviceimprovementscreen
...
class ServiceImprovementScreen : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_service_improvement_screen)
    ...
    private fun reportAPICall() {
        ...
        try {
            ...
            if (defaultIdLog.equals("")){
                ...
                req["title"] =   "Service improvment suggestions"
