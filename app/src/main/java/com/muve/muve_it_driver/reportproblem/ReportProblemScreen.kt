package com.muve.muve_it_driver.reportproblem
...
class ReportProblemScreen : AppCompatActivity() {
    ...
    private fun reportAPICall() {
        ...
        try {
            ...
            if (defaultIdLog.equals("")){
                ...
                req["title"] =   "Report a problem with the application"
